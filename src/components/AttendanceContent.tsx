...
const AttendanceContent: React.FC = () => {
    ...
    // Log the current values to check if they are set correctly
    console.log({
        facultyID,
        dayOfWeek,
        startTime,
    ...
    // Implement the edit submit logic here
    console.log("Edited schedule submitted");
    ...
    const renderModalContent = () => (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white rounded-lg shadow-lg w-1/2 p-6 relative">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-[#800000]">Add Schedule</h2>
                    <button 
                        ...
                        {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map((day) => (
                            <div key={day} className="flex items-center">
                                <input 
                                    type="checkbox" 
                                    className="h-4 w-4" 
                                    onChange={() => setDayOfWeek(day)} 
                                />
                                <label className="ml-2">{day}</label>
                                <input 
                                    type="time" 
                                    className="border border-gray-300 rounded p-1 ml-2 w-24"
    ...
    return (
        <div className="text-black p-4 min-h-screen">
            ...
            {activeTab === 'attendance' && (
                <div>
                    <div className="bg-white shadow-lg p-4 rounded-lg h-[75vh] flex items-start justify-center">
                        <main className="flex-1 p-6">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-3 sm:space-y-0">
                                {/* Search Bar */}
                                <div className="flex items-center gap-2 mb-4">
                            ...
                            <table className="w-full text-md text-left border-collapse border-t">
                                <thead className="bg-gray-100 text-black text-md font-semibold">
                                    <tr>
                                        {["Faculty", "Date", "Time In", "Time Out", "Status", "Actions", "DTR"].map((header) => (
                                            <th key={header} className="border border-white px-3 py-2 font-semibold text-black">
                                                {header}
                                            </th>
                                        ))}
                                    </tr>
