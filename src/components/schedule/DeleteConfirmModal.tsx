  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-2 sm:p-4">
        <div
          className="relative bg-white text-gray-900 rounded-lg shadow-xl max-w-md w-full mx-2 sm:mx-0"
        ...
        >
          ...
          <div className="px-4 sm:px-6 pb-4 sm:pb-6">
            ...
            <p className="text-sm text-gray-500 text-center mb-4 sm:mb-6">{message}</p>
