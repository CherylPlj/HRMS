...
//         console.error('Error inserting into Supabase:', errorDetails);
//         return new Response(
//         JSON.stringify({ error: 'Failed to create user in Supabase', details: errorDetails }),
//         { status: 500 }
//         );
//     }
...
//     return new Response(
//         JSON.stringify({ message: 'User created successfully', userId: data[0]?.id ?? data.id }),
//         { status: 200 }
//     );
