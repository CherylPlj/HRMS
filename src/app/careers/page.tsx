...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {showSectionNav && (
        <div className="sticky top-[80px] md:top-[90px] z-40 bg-white shadow-md border-b" style={{ borderColor: '#F0E68C' }}>
          <div className="container mx-auto px-4 md:px-8">
            <nav className="flex items-center justify-start sm:justify-center gap-2 md:gap-6 py-2 md:py-3 overflow-x-auto no-scrollbar">
              <button
                onClick={() => scrollToSection('job-openings')}
                className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-lg font-medium text-xs md:text-sm whitespace-nowrap transition-all duration-200 hover:bg-gray-100 flex-shrink-0"
                style={{ color: '#8B0000' }}
              >
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 id="job-openings" className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 mt-12" style={{ color: '#8B0000' }}>
          ...
          <div id="application-process" className="mt-12 scroll-mt-24">
            ...
            <p className="text-sm sm:text-base mb-8" style={{ color: '#8B0000' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="rounded-lg p-6" style={{ backgroundColor: '#FFE4E1' }}>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-white font-bold text-lg sm:text-xl mb-4 mx-auto" style={{ backgroundColor: '#8B0000' }}>
                  1
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-3 text-center" style={{ color: '#8B0000' }}>Submit Application</h3>
              ...
              <div className="rounded-lg p-6" style={{ backgroundColor: '#FFE4E1' }}>
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-3 text-center" style={{ color: '#8B0000' }}>Initial Screening</h3>
                <p className="text-black text-center text-xs sm:text-sm">
              ...
              <div className="rounded-lg p-6" style={{ backgroundColor: '#FFE4E1' }}>
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-3 text-center" style={{ color: '#8B0000' }}>Interview Process</h3>
                <p className="text-black text-center text-xs sm:text-sm">
            ...
            <div className="rounded-lg p-6 sm:p-8" style={{ backgroundColor: '#FFFACD' }}>
              <h3 className="text-xl sm:text-2xl font-bold mb-4" style={{ color: '#8B0000' }}>Ready to Apply?</h3>
              <p className="text-sm sm:text-base mb-6 text-black">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-black">
                  ...
                  <Link href="/applicant" className="text-sm sm:text-base text-black hover:underline">
                    HRMS - Applicant Portal
                  </Link>
                </div>
                <div className="flex items-center gap-3 text-black">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-black" />
                  <a href="mailto:sjsfihrms@gmail.com" className="text-sm sm:text-base text-black hover:underline">
                    sjsfihrms@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-3 text-black">
                  <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-black" />
                  <span className="text-sm sm:text-base">(02) 8-693-5661</span>
                </div>
              ...
              <div className="bg-white rounded-lg p-4 sm:p-6">
                <h4 className="text-base sm:text-lg font-bold mb-4" style={{ color: '#8B0000' }}>Required Documents:</h4>
