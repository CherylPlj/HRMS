...
const publicRoutes = [
    ...
    "/api/xr/section-assignments",
    "/api/xr/faculty-availability/(.*)",
    "/api/xr/faculty-qualifications/(.*)",
    "/api/xr/faculty-workload/(.*)",
    "/api/xr/faculty-workload/validate",
    "/api/schedules/fetch-from-sis/sync-section-advisers",
